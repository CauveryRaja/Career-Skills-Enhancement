...
@Component({
  selector: 'app-taptitude',
  templateUrl: './taptitude.component.html',
  styleUrls: ['./taptitude.component.css']
})
export class TaptitudeComponent implements OnInit, OnDestroy {
